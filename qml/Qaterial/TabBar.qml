...
T.TabBar
{
  ...
  property Component highlightItem: _defaultHighlightItem
  property alias defaultHighlightItem: _defaultHighlightItem

  Component {
	  id:  _defaultHighlightItem
  ...
  contentItem: ListView
  {
	...
	highlight: _control.highlightItem
  } // ListView
