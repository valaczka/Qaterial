...
T.ItemDelegate
{
  ...
  property alias leftPlaceholderSource: _content.leftPlaceholderSource
  property alias leftPlaceholderSourceComponent: _content.leftPlaceholderSourceComponent

  property alias rightPlaceholderSource: _content.rightPlaceholderSource
  property alias rightPlaceholderSourceComponent: _content.rightPlaceholderSourceComponent

  property alias leftAsynchronous: _content.leftAsynchronous
  property alias rightAsynchronous: _content.rightAsynchronous
  ...
  contentItem: Qaterial.ListDelegateLoaderPlaceholderContent
  {
	id: _content
	text: control.text
