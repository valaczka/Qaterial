...
QtObject
{
  ...
  function openListView(radioListViewDialogSettings)
  {
	if(dialogLoader)
	  dialogLoader.openListView(radioListViewDialogSettings)
  }

  function openCheckListView(checkListViewDialogSettings)
  {
	if(dialogLoader)
	  dialogLoader.openCheckListView(checkListViewDialogSettings)
  }
