...
T.ItemDelegate
{
  ...
  property alias contentSource: _content.contentSource
  property alias contentSourceComponent: _content.contentSourceComponent
  ...
  contentItem: Qaterial.ListDelegateFullLoaderContent
  {
	id: _content
